    ...
    <>
        ...
        <form onSubmit={(e) => mutation.mutate(e)}>
            ...
            <textarea
                ...
                name='comment'
                ref={inputRef}
                className="w-full max-h-[400px] min-h-[100px] sm:w-2/3 block  lg:w-1/3 rounded-md border-0 py-1.5 px-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 text-lg"
              />
